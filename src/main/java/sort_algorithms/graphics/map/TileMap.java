package sort_algorithms.graphics.map;
...
import sort_algorithms.graphics.IOrderRenderer;
            ...
            for (int x = 0; x < chunk.getWidth(); x++) {
                ...
                if (gid > 0) {
                    ...
                    if (!this.batches.containsKey(currentTileset)) {
                        ...
                        BufferedImage image = Wrapper.getCacheManager().loadImage(String.format("/graphic/%s", path));
