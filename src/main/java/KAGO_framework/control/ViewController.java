...
import sort_algorithms.event.events.KeyPressedEvent;
import sort_algorithms.model.scene.Scene;
import sort_algorithms.model.scene.impl.LoadingScene;
import sort_algorithms.model.transitions.DefaultTransition;
import sort_algorithms.utils.panel.DebugPanel;
...
public class ViewController extends Canvas implements KeyListener, MouseListener, MouseMotionListener {
    ...
    public ViewController() {
        ...
        if (!sort_algorithms.Config.SHOW_DEFAULT_WINDOW) {
    ...
    public void recreateBackBuffer() {
        ...
        this.createBufferStrategy(sort_algorithms.Config.NUM_BUFFERS);
    }
    ...
    private void createWindow(){
        ...
        int x = this.screenWidth / 2 - sort_algorithms.Config.WINDOW_WIDTH / 2;
        int y = this.screenHeight / 2 - sort_algorithms.Config.WINDOW_HEIGHT / 2;
        logger.info("Graphics Device: {}", gd.getIDstring());

        if (sort_algorithms.Config.RUN_ENV == sort_algorithms.Config.Environment.PRODUCTION) {
            Scene.open(new LoadingScene(), new DefaultTransition());
        }
        this.drawFrame = new DrawFrame(sort_algorithms.Config.WINDOW_TITLE, x, y, sort_algorithms.Config.WINDOW_WIDTH, sort_algorithms.Config.WINDOW_HEIGHT, this);
        ...
        if (sort_algorithms.Config.WINDOW_FULLSCREEN) {
        ...
        if (sort_algorithms.Config.RUN_ENV == sort_algorithms.Config.Environment.DEVELOPMENT) {
            Scene.showGameScene();
        }
    }
